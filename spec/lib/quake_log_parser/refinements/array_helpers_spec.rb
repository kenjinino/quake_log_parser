...
shared_examples "find and compare" do |players, dummy_player|

  it "a player and it's array" do
    @found_player = players.find_or_create_player_by_id_and_name(dummy_player.id, dummy_player.name)
...
describe "Array helpers" do
  ...
  describe "#find_or_create_player_by_id_and_name" do
    ...
    context "new player" do
      ...
      it_should_behave_like "find and compare", Array.new, @dummy_player
    end
